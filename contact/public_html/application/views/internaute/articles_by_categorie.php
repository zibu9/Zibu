...
<body>
    <div class="page-wrapper">
		...
		?>
		<section class="page-title" style="background-image:url(<?=base_url()?>/assets/user/images/parallax/<?=$categorie?>.jpg);">
            <div class="auto-container">
                <div class="sec-title">
                    <h1><span class="normal-font"><?=$categorie?></span></h1>
                    <div class="bread-crumb"><a href="<?=site_url()?>">Accueil</a> / <a href="<?=site_url('article/categories/'.$categorie)?>" class="current"><?=$categorie?></a></div>
                </div>
            </div>
        </section>
		<?php
