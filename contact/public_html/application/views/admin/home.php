...
<head>
  ...
  <title>Admin | Oeil du journal</title>
  ...
  <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?=site_url('admin/articles_by_categories/Politique')?>" class="small-box-footer">Voir plus<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?=$securite?><sup style="font-size: 20px"></sup></h3>
            ...
            <a href="<?=site_url('admin/articles_by_categories/Securite')?>" class="small-box-footer">Voir plus <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?=site_url('admin/articles_by_categories/Economie')?>" class="small-box-footer">Voir plus <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?=site_url('admin/articles_by_categories/Societe')?>" class="small-box-footer">Voir plus <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
              ...
              <ul class="todo-list">
								<?php foreach ($les_articles as $article):?>
									<li>
										...
										<div class="tools">
									  	<a href="<?php echo site_url('commentaire/all_article_comments_admin/'.$article->id); ?>">Commentaires</a>
											<a href="<?php echo site_url('article/edit_article/'.$article->id); ?>">Editer</a>
											<a href="<?php echo site_url('article/archive_article/'.$article->id); ?>"><i class="fa fa-trash-o"></i></a>
											<a href="<?php echo site_url('article/delete_article/'.$article->id); ?>"><i class="fa fa-times"></i></a>
										</div>
									</li>
								<?php endforeach;?>
              </ul>
