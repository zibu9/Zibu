...
<?php
			...
			<?php if (!empty($this->session->flashdata('msg'))):?>
				<?php if ($this->session->flashdata('msg') == 'insert_true'):?>
					<div class="alert alert-dismissible alert-success">
						...
						<strong>Bien Fait!</strong> Action effectuée!!! <a href="#" class="alert-link">Article enregistré avec succès</a>
					</div>
				...
				<?php elseif ($this->session->flashdata('msg') == 'update_true'):?>
					<div class="alert alert-dismissible alert-success">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Bien Fait!</strong> Action effectuée!!! <a href="#" class="alert-link">Article modifié avec succès</a>
					</div>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Publications de la catégorie </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <ul class="todo-list">
								<?php foreach ($all_article as $article):?>
									<li>
										...
										<!-- Emphasis label -->
										<small class="label label-danger"><i class="fa fa-clock-o"></i>  <?=$article->date_pub?></small>
  ...
  <?php
    ...
    include_once("controlsidebar_admin.php");
  ?>
