...
<head>
  ...
  <title>Admin | Changer vos coordonnées</title>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <?=form_open_multipart('admin/submit_update_admin') ?>
              <div class="box-body pad">
				<div class="col-md-12">
					<div class="form-group">
							<label for="exampleInputEmail1">Nom d'utilisateur</label>
							<?= form_input([ 'type'=>"text", 'class'=>"form-control", 'id'=>"exampleInputEmail1", 'name'=>"username", 'value'=>$update_data->username])?>
							<!--input type="text" class="form-control" id="exampleInputEmail1" name="titre">-->
							<?=form_error('titre', '<p class="text-danger">', '</p>')?>
					</div>
					<div class="form-group">
							<label for="exampleInputEmail1">Mot de passe</label>
							<?=form_input([ 'type'=>"password", 'class'=>"form-control", 'id'=>"exampleInputEmail1", 'name'=>"password", 'value'=>$update_data->password])?>
